    ...
    <header class="base-header">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="imagestart.jpg" alt="Product 1"></div>
                <div class="swiper-slide"><img src="image1.jpg" alt="Product 2"></div>
                <div class="swiper-slide"><img src="image2.jpg" alt="Product 3"></div>
            </div>
